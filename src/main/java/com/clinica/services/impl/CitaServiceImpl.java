...
public class CitaServiceImpl implements CitaService {
    ...
    public CitaResponseDTO programarCita(CitaRequestDTO request) {
        ...
        // Resolución del paciente vinculado a la cita
        Paciente paciente;
        if (request.getPacienteId() != null) {
            ...
            paciente = obtenerOCrearPacienteDesdeHistoria(request.getHistoriaClinicaId(), creador);
        }
        ...
        return pacienteRepository.findByHistoriaClinicaId(historiaClinicaId)
                .orElseGet(() -> {
                    HistoriaClinica historia = historiaClinicaRepository.findById(historiaClinicaId)
                            .orElseThrow(() -> new RecursoNoEncontradoException("Historia no encontrada: " + historiaClinicaId));
