...
public class AdmisionService {
     ...
     *
     * <p>Regla de negocio: el DNI es el identificador único del paciente.
     * Si ya existe una historia con ese DNI, lanza excepción (no se permite duplicado).</p>
     *
     * <p>Flujo de Admisión: si {@code desdeAdmision = true}, el DTO de respuesta
     ...
     * pre-cargados, evitando el reingreso manual.</p>
     */
    @Transactional
     ...
     * Para producción considerar una secuencia de BD o un campo autoincremental dedicado.
     */
